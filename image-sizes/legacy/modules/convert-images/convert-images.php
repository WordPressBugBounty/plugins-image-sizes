...
class Convert_Images extends Base {
	...
	public function convert_image_on_upload( $file_info ) {
		...
		if( ! in_array( $file_info['type'], function_exists( 'thumbpress_supported_image_mimes' ) ? thumbpress_supported_image_mimes( array( 'image/webp' ) ) : ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/bmp', 'image/avif'] ) ) return $file_info;
	...
	public function display_convert_image_btn( $form_fields, $post ) {
		if( ! in_array( $post->post_mime_type, function_exists( 'thumbpress_supported_image_mimes' ) ? thumbpress_supported_image_mimes( array( 'image/webp' ) ) : ['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/bmp', 'image/avif'] ) ) return $form_fields;
	...
	public function schedule_image_conversion() {
		...
		global $wpdb; 
		$image_types 			 = function_exists( 'thumbpress_supported_image_mimes' ) ? thumbpress_supported_image_mimes( array( 'image/webp' ) ) : [ 'image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/bmp', 'image/avif' ];
