...
trait Asset {
	 ...
	 * @param string $ver       Script version, defaults to the constant THUMBPRESS_VERSION.
	 ...
	 * @param string $ver    Style version, defaults to the constant THUMBPRESS_VERSION.
	 ...
	 * Otherwise, returns the specified version or the THUMBPRESS_VERSION constant if no version is provided.
	 *
