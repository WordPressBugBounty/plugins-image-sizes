...
class Email {
	...
	public function set_footer( $content = '' ) {
		...
		?>
			<div class="footer" style="background: #f8f8f8; padding: 20px; text-align: center;">
				<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Thumbpress. All rights reserved.', 'image-sizes' ); ?></p>
				<?php if ( $content ) : ?>
	...
	public function set_template( $template_name, $args = array() ) {
		$template_path = THUMBPRESS_PLUGIN_DIR . 'views/emails/' . $template_name . '.php';
