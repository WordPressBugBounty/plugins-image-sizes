...
use Codexpert\ThumbPress\Abstracts\Image_Converter;
...
class Convert_Webp extends Image_Converter {
	...
	/**
	 * Clear WebP stat caches after a successful on-upload conversion.
	 */
	...
	public function get_image_mime_types_for_webp( $formats ) {
		return $this->get_image_mime_types( $formats );
	}

	public function convert_image_to_webp( $source ) {
		return $this->convert_image( $source );
	}
