	...
	public function init_menu() {
		...
		if( ! defined( 'THUMBPRESS_PRO' ) ) {
		    ...
		    $upgrade_pro = [
		        'id'            => "upgrade-to-pro",
		        'parent'        => 'thumbpress',
		        'label'         => __( 'New Year Sale (Up to 60% Off)', 'image-sizes' ), // Remove HTML tags
		        'title'         => __( 'New Year Sale (Up to 60% Off)', 'image-sizes' ),
		        'header'        => __( 'New Year Sale (Up to 60% Off)', 'image-sizes' ),
		        'priority'      => 100,
		        'sections'      => [
		            'upgrade-to-pro'=> [
		                'id'        => 'upgrade-to-pro',
		    ...
		    $upgrade_pro['label'] = '<span style="font-weight: bold;">New Year Sale (Up to 60% Off)</span></span>';
