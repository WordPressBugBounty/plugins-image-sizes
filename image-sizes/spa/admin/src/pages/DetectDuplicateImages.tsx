...
export default function DetectDuplicateImages({ tooltip }: { tooltip?: string } = {}) {
	...
	return (
		<>
			...
			<PluginPage>
				<Card
					title="Find & Remove Duplicate Images"
					description="Duplicates inflate storage and bloat backups. Find every redundant file and clean house without risking your originals."
				>
					...
					<ProAlert
						title="Duplicate Image Detection is a Pro feature"
						description="The same file uploaded twice wastes space every day. Surface every duplicate and reclaim storage you didn't know you were losing."
						buttonText="Upgrade to detect duplicate images"
						open={alertOpen}
