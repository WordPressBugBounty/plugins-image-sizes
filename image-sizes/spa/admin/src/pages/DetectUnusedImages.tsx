...
export default function DetectUnusedImages({ tooltip }: { tooltip?: string } = {}) {
	...
	return (
		<>
			...
			<PluginPage>
				<Card
					title="Find & Remove Unused Images"
					description="You're paying to host images nobody sees. Remove orphaned files and cut hosting costs, backup size, and storage waste instantly."
				>
					{/* Empty state */}
					<div className="flex flex-col items-center py-10">
						<img src={detectImageUrl} alt="" />
						<h3 className="text-xl font-bold text-thumbpress-title mb-[6px]">
							Ready to Scan for Unused Images?
						</h3>
						<p className="text-sm text-[#64748B] mb-8">
							Click "Detect Now" to scan your library across Gutenberg, Elementor, WooCommerce, ACF, and LayerSlider for unused images.
						</p>
					...
					<ProAlert
						title="Unused Image Cleanup is a Pro feature"
						description="A bloated library slows uploads, backups, and searches. Remove dead weight and keep your site lean and fast."
						buttonText="Upgrade to clean up unused images"
						open={alertOpen}
