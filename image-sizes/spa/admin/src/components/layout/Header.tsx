	...
	return (
		<div className="h-[80px] w-full px-8 flex items-center justify-between bg-white">
            ...
            <div className="flex items-center gap-4 text-sm font-medium text-thumbpress-body">
                ...
                { !isProActive && (
                    <a href="#/pro?src=header" className="flex items-center gap-2.5 !text-white bg-thumbpress-primary hover:bg-thumbpress-primary-hover duration-300 px-4 py-2.5 rounded-lg">
